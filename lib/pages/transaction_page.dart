...
import 'package:draja_steam/models/transaction_with_category.dart';
...
class _TransactionPageState extends State<TransactionPage> {
  ...
  Future update(int transactionId, int amount, int categoryId, DateTime transactionDate, String nameDetail) async {
    return await database.updateTransactionRepo(transactionId, amount, categoryId, transactionDate, nameDetail);
  }
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(border: UnderlineInputBorder(), labelText: "Jumlah"),
                ),
              ),
              SizedBox(height: 25,),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16),
                child: Text("Kategori", style: GoogleFonts.montserrat(fontSize: 16),),
              ),
                        ...
                        return Padding(
                          ...
                          child: DropdownButton<Category>(
                            ...
                            items: snapshot.data!.map((Category item) {
                              return DropdownMenuItem<Category>(value: item, child: Text(item.name),);
                            }).toList(),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(border: UnderlineInputBorder(), labelText: "Rincian"),
                ),
              ),
              SizedBox(height: 25,),
              Center(
